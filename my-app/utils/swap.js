...
export const getAmountOfTokensReceivedFromSwap = async (
  ...
  if (ethSelected) {
    ...
    // `_swapAmountWei`, the input reserve would be the `Crypto Dev` token reserve of the contract and out reserve
...
export const swapTokens = async (
  ...
  // it is the ether we are paying the contract, instead of a value we are passing to the function
  if (ethSelected) {
